...
def send_email_alert(driver_id, status):
    sender_email = "mamidiarvind123@gmail.com"
    receiver_email = "22x35a0423@gmail.com"
    password = "zxrh wiuv idxx uhbm"

    subject = f"Drowsiness Alert - {driver_id}"
    body = f"""
    Hello,

    Driver {driver_id} has been detected as {status}.
...
def detect_drowsiness():
    ...
    try:
            ...
            for face in faces:
                ...
                if left_blink == 0 or right_blink == 0:
                    ...
                    if sleep > 15:
                        ...
                        sleep_count += 1
                        if not email_sent:
                            send_email_alert(driver_id, status)
                            email_sent = True
        ...
        msg.showinfo("Session Complete", f"Driver: {driver_id}\nDrowsy: {drowsy_count}\nSleep: {sleep_count}\nClass: {driver_class}\nPDF saved as report_{driver_id}.pdf")
